...
Baseline (2026-07-06): **GATE OK** — **0 bug, 0 vuln, 0 hotspot, 0 code smell**,
0 new_violations, coverage tổng ~57% / new code 75.9%, dup 0%. Toàn bộ smell cognitive-
complexity đã refactor (Handler, matchRoute, certstore.scan, manager.Scan, test helper).
